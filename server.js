...
function scheduleReminder(reminder) {
  ...
  const task1 = cron.schedule(
    `0 ${dayReminder.getMinutes()} ${dayReminder.getHours()} ${dayReminder.getDate()} ${dayReminder.getMonth() + 1} *`,
    () => {
      const msg = {
        to: email,
        from: 'olagunjuismail7@gmail.com',
  ...
  const task2 = cron.schedule(
    `0 ${hourReminder.getMinutes()} ${hourReminder.getHours()} ${hourReminder.getDate()} ${hourReminder.getMonth() + 1} *`,
    () => {
      const msg = {
        to: email,
        from: 'olagunjuismail7@gmail.com',
 ...
 task2.start();
  ...
  const task3 = cron.schedule(
    `0 ${minsReminder.getMinutes()} ${minsReminder.getHours()} ${minsReminder.getDate()} ${minsReminder.getMonth() + 1} *`,
    () => {
      const msg = {
        to: email,
        from: 'olagunjuismail7@gmail.com',
